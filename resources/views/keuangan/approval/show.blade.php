            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            <a href="{{ route('keuangan.approval.index', ['bulan' => $payroll->bulan, 'tahun' => $payroll->tahun, 'status' => $status]) }}"
                            ...
                            @if($payroll->status == 'pending')
                                ...
                                <!-- Form Tombol Approve -->
                                <form action="{{ route('keuangan.approval.approve', $payroll) }}" method="POST"
                                ...
                                <tfoot class="border-top">
                                    <tr>
                                        ...
                                        <td class="text-end fw-semibold text-success">Rp
                                            {{ number_format($payroll->gaji_kotor, 0, ',', '.') }}
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                                ...
                                <tfoot class="border-top">
                                    <tr>
                                        ...
                                        <td class="text-end fw-semibold text-danger">(Rp
                                            {{ number_format($payroll->total_potongan, 0, ',', '.') }})
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
    ...
    <div class="modal fade" id="rejectModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('keuangan.approval.reject', $payroll) }}" method="POST">
                    @csrf
