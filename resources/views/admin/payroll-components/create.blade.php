    ...
    <div class="col-lg-8 col-md-12">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Formulir Komponen Gaji Baru</h5>
                ...
                <form action="{{ route('admin.payroll-components.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('tipe') is-invalid @enderror" id="tipe" name="tipe" required>
                            ...
                            <option value="allowance" {{ old('tipe') == 'allowance' ? 'selected' : '' }}>Tunjangan
                                (Penambah Gaji)</option>
                            <option value="deduction" {{ old('tipe') == 'deduction' ? 'selected' : '' }}>Potongan
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_default') is-invalid @enderror"
                                id="jumlah_default" name="jumlah_default" value="{{ old('jumlah_default', 0) }}" min="0"
                                step="1000" />
                        </div>
