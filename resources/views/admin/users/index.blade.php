                ...
                <tbody class="table-border-bottom-0">
                    @forelse ($users as $index => $user)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a class="btn btn-sm btn-icon btn-info me-2" href="{{ route('admin.users.edit', $user) }}"
                                        data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" title="Edit User">
