                            ...
                            <td>
                                <div class="d-flex">
                                    <a class="btn btn-sm btn-icon btn-dark me-2"
                                        href="{{ route('karyawan.pengajuan-lembur.show', $lembur) }}" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="top" title="Lihat Detail">
                                        <i class="bx bx-show"></i>
                                    </a>
                                    <!-- Karyawan hanya bisa edit/hapus jika masih pending -->
                                    @if ($lembur->status == 'pending_hrd')
                                        <a class="btn btn-sm btn-icon btn-info me-2"
                                            href="{{ route('karyawan.pengajuan-lembur.edit', $lembur) }}" data-bs-toggle="tooltip"
                                            data-bs-offset="0,4" data-bs-placement="top" title="Edit Lembur">
                                            <i class="bx bx-edit-alt"></i>
                                        </a>
                                        <form action="{{ route('karyawan.pengajuan-lembur.destroy', $lembur) }}" method="POST"
