...
<div class="col-sm-8">
<p class="form-control-plaintext">{{ $pengajuan_lembur->jam_mulai }} s/d {{ $pengajuan_lembur->jam_selesai }}</gaji>
</div>
</div>
<div class="row mb-3">
...
<div class="col-sm-8">
<p class="form-control-plaintext" style="white-space: pre-wrap;">{{ $pengajuan_lembur->alasan_lembur }}</p>
</div>
</div>
            ...
            @if ($pengajuan_lembur->status == 'pending')
                <div class="d-flex justify-content-start gap-2 mt-4">
                    <a href="{{ route('karyawan.pengajuan-lembur.edit', $pengajuan_lembur->id) }}" class="btn btn-info">
                        <i class="bx bx-edit-alt me-1"></i> Edit Pengajuan
                    </a>
                    <form action="{{ route('karyawan.pengajuan-lembur.destroy', $pengajuan_lembur->id) }}" method="POST"
