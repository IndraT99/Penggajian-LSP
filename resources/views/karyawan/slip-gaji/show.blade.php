...
<div class="row">
    <div class="col-12 text-center mb-4">
        <a href="{{ route('karyawan.slip.index') }}" class="btn btn-secondary me-2">
            <i class="bx bx-arrow-back me-1"></i> Kembali ke Daftar
        </a>
        <a href="{{ route('karyawan.slip-gaji.pdf', $payroll->id) }}" target="_blank" class="btn btn-danger">
            ...
            <div class="card-body p-5">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        ...
                        <p class="mb-0 fw-semibold">Periode: {{ \Carbon\Carbon::create()->month($payroll->bulan)->translatedFormat('F') }} {{ $payroll->tahun }}</p>
                        <p class="text-muted mb-0">Status: 
                            @if ($payroll->status == 'approved_finance') <span class="badge bg-label-success">Disetujui</span>
                        ...
                        <table class="table table-sm table-borderless">
                            ...
                            <tfoot class="border-top">
                                <tr>
                                    ...
                                    <td class="text-end fw-semibold text-success">Rp {{ number_format($payroll->gaji_kotor, 0, ',', '.') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                        ...
                        <table class="table table-sm table-borderless">
                            ...
                            <tfoot class="border-top">
                                <tr>
                                    ...
                                    <td class="text-end fw-semibold text-danger">(Rp {{ number_format($payroll->total_potongan, 0, ',', '.') }})</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="alert alert-primary p-4" role="alert">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <h4 class="alert-heading mb-0">Rp {{ number_format($payroll->gaji_bersih, 0, ',', '.') }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
...
<style> 
    @media print {
        ...
        .btn, .layout-navbar, .layout-menu {
            display: none !important;
        }
        .content-wrapper, .layout-page, .container-xxl {
            padding: 0 !important;
            margin: 0 !important;
        }
    }
