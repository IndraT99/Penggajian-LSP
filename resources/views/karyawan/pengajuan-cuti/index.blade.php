                            ...
                            <td>
                                <div class="d-flex">
                                    <a class="btn btn-sm btn-icon btn-dark me-2"
                                        href="{{ route('karyawan.pengajuan-cuti.show', $cuti) }}" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="top" title="Detail Cuti">
                                        <i class="bx bx-show"></i>
                                    </a>
                                    @if ($cuti->status == 'pending_hrd')
                                        <a class="btn btn-sm btn-icon btn-info me-2"
                                            href="{{ route('karyawan.pengajuan-cuti.edit', $cuti) }}" data-bs-toggle="tooltip"
                                            data-bs-offset="0,4" data-bs-placement="top" title="Edit Cuti">
                                            <i class="bx bx-edit-alt"></i>
                                        </a>
                                        <form action="{{ route('karyawan.pengajuan-cuti.destroy', $cuti) }}" method="POST"
