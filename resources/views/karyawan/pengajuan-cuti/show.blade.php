                ...
                <div class="card-body">
                    ...
                    @if ($pengajuan_cuti->status == 'pending')
                        <div class="d-flex justify-content-start gap-2 mt-4">
                            <a href="{{ route('karyawan.pengajuan-cuti.edit', $pengajuan_cuti) }}" class="btn btn-info">
                                <i class="bx bx-edit-alt me-1"></i> Edit
                            </a>
                            <form action="{{ route('karyawan.pengajuan-cuti.destroy', $pengajuan_cuti) }}" method="POST"
