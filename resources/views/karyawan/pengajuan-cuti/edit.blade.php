        ...
        <div class="col-lg-8 col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('karyawan.pengajuan-cuti.update', $pengajuan_cuti) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                    ...
                                    value="{{ old('tanggal_mulai', $pengajuan_cuti->tanggal_mulai->format('Y-m-d')) }}"
                                    required />
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror"
                                    ...
                                    value="{{ old('tanggal_selesai', $pengajuan_cuti->tanggal_selesai->format('Y-m-d')) }}"
                                    required />
