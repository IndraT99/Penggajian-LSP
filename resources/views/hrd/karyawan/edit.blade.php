    ...
    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('gaji_pokok') is-invalid @enderror"
                                id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok', $karyawan->gaji_pokok) }}"
                                min="0" required />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="divisi_id" name="divisi_id"
                            ...
                            <option value="{{ $divisi->id }}"
                                {{ old('divisi_id', $karyawan->divisi_id) == $divisi->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="status_karyawan" name="status_karyawan"
                            ...
                            <option value="non_aktif"
                                {{ old('status_karyawan', $karyawan->status_karyawan) == 'non_aktif' ? 'selected' : '' }}>
                                Non-Aktif</option>
                            <option value="resign"
                                {{ old('status_karyawan', $karyawan->status_karyawan) == 'resign' ? 'selected' : '' }}>
                                Resign</option>
                        </select>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @php
                        $oldId = old("components.$component->id.id");
                        $oldJumlah = old("components.$component->id.jumlah");

                        $isChecked = !is_null($oldId) || (is_null(old('components')) &&
                        isset($currentComponentData[$component->id]));
                        $jumlah = $oldJumlah ?? ($currentComponentData[$component->id] ?? $component->jumlah_default);
                        @endphp
                        <div class="col-md-6 mb-3">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control component-jumlah"
                                    ...
                                    name="components[{{ $component->id }}][jumlah]" value="{{ $jumlah }}" min="0"
                                    step="1000" {{ !$isChecked ? 'disabled' : '' }}>
                            </div>
                        </div>
                        @endforeach
                    </div>
        ...
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary btn-lg">
                <i class="bx bx-save me-1"></i> Update Karyawan
            </button>
