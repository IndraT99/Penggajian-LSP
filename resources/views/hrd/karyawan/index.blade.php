                    ...
                    <td>
                        <div class="d-flex">
                            <a class="btn btn-sm btn-icon btn-dark me-2"
                                href="{{ route('hrd.karyawan.show', $karyawan->id) }}" data-bs-toggle="tooltip"
                                data-bs-offset="0,4" data-bs-placement="top" title="Lihat Profil">
                                <i class="bx bx-show"></i>
                            </a>
                            <a class="btn btn-sm btn-icon btn-info me-2"
                                href="{{ route('hrd.karyawan.edit', $karyawan->id) }}" data-bs-toggle="tooltip"
                                data-bs-offset="0,4" data-bs-placement="top" title="Edit Karyawan">
                                <i class="bx bx-edit-alt"></i>
                            </a>
                            <form action="{{ route('hrd.karyawan.destroy', $karyawan->id) }}" method="POST"
