    ...
    <div class="col-lg-8 col-md-12">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Formulir Edit Lembur Karyawan</h5>
                ...
                <form action="{{ route('hrd.lembur.update', $lembur->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="employee_id" name="employee_id"
                            ...
                            <option value="{{ $employee->id }}"
                                {{ old('employee_id', $lembur->employee_id) == $employee->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror" id="tanggal"
                            name="tanggal" value="{{ old('tanggal', $lembur->tanggal->format('Y-m-d')) }}" required />
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('jam_mulai') is-invalid @enderror"
                                id="jam_mulai" name="jam_mulai" value="{{ old('jam_mulai', $lembur->jam_mulai) }}"
                                required />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('jam_selesai') is-invalid @enderror"
                                ...
                                value="{{ old('jam_selesai', $lembur->jam_selesai) }}" required />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="alasan_lembur" name="alasan_lembur"
                            ...
                            required>{{ old('alasan_lembur', $lembur->alasan_lembur) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('biaya_lembur') is-invalid @enderror"
                                id="biaya_lembur" name="biaya_lembur"
                                value="{{ old('biaya_lembur', $lembur->biaya_lembur) }}" min="0" required />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="status" name="status" class="form-select @error('status') is-invalid @enderror"
                            required>
                            <option value="pending" {{ old('status', $lembur->status) == 'pending' ? 'selected' : '' }}>
                                Pending</option>
                            <option value="approved_hrd"
                                {{ old('status', $lembur->status) == 'approved_hrd' ? 'selected' : '' }}>Disetujui
                            </option>
                            <option value="rejected"
                                {{ old('status', $lembur->status) == 'rejected' ? 'selected' : '' }}>Ditolak</option>
                        </select>
                        <small class="form-text text-muted">Jika diubah menjadi 'Disetujui', akun Anda akan dicatat
                            sebagai approver.</small>
                        @error('status') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <button type="submit" class="btn btn-primary">Update Data Lembur</button>
                </form>
            </div>
        </div>
    </div>
