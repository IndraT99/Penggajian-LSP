...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Data Pengajuan Lembur ({{ \Carbon\Carbon::create()->month($bulan)->translatedFormat('F') }}
            {{ $tahun }})</h5>
                    ...
                    <td>
                        <div class="d-flex">
                            <a class="btn btn-sm btn-icon btn-info me-2"
                                href="{{ route('hrd.lembur.edit', $lembur->id) }}" data-bs-toggle="tooltip"
                                data-bs-offset="0,4" data-bs-placement="top" title="Edit/Approve">
                                <i class="bx bx-edit-alt"></i>
                            </a>
                            @if ($lembur->status != 'approved_hrd')
                            <form action="{{ route('hrd.lembur.destroy', $lembur->id) }}" method="POST"
